...
public class BindViewTest {
  ...
  @Test public void oneFindPerId() {
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/Test$$ViewBinder", ""
        ...
        + "      this.target = target;\n"
        + "      target.thing1 = finder.findRequiredView(source, 1, \"field 'thing1' and method 'doStuff'\");\n"
        + "      target.thing1.setOnClickListener(new DebouncingOnClickListener() {\n"
        + "        @Override\n"
        ...
        + "      T target = this.target;\n"
        + "      if (target == null) throw new IllegalStateException(\"Bindings already cleared.\");\n"
        + "      target.thing1.setOnClickListener(null);\n"
        + "      target.thing1 = null;\n"
        + "      this.target = null;\n"
        + "    }\n"
        + "  }\n"
